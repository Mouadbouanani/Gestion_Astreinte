...
const ServiceManagement: React.FC = () => {
  ...
  // Check if current user can manage services in their secteur
  const canManageServices = user?.role === 'chef_secteur' && user?.secteur;
      ...
      <div className="flex items-center justify-between">
        <div className="flex items-center space-x-3">
          ...
          <div>
            ...
            <p className="text-gray-600">Gérer les services de votre secteur</p>
          </div>
        </div>
        {canManageServices && (
          <Button
